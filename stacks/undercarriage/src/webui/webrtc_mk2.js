...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var signalling_server_hostname = location.hostname || "10.0.10.10";
    ...
    <body>
        ...
        <div id="commands">
            <details open>
                ...
                <fieldset>
                    <span>Remote Peer/Signalling Server Address: </span><input required type="text" id="signalling_server" value="10.0.10.10:8080" title="<host>:<port>, default address is autodetected"/><br>
