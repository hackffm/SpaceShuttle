...
$(document).ready(function() {
    ...
    */
	...
	document.getElementById('btnExtra1').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '1'}});
	});

	document.getElementById('btnExtra2').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '2'}});
	});

	document.getElementById('btnExtra3').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '3'}});
	});

	document.getElementById('btnExtra4').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '4'}});
	});

	document.getElementById('btnExtra5').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '5'}});
	});

	document.getElementById('btnExtra6').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'extra', data: '6'}});
	});

	document.getElementById('btnShutdown').addEventListener('click',function(event) {
		$.ajax({type: "POST", url: "cgi", data: {cmd: 'shutdown'}});
	});
